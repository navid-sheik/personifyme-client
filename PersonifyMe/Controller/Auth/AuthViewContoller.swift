...
//        skipButton.backgroundColor =  .red
        ...
        authHeader.anchor(top: skipButton.bottomAnchor, left: nil, right: nil, bottom: nil, paddingTop: 0, paddingLeft: 0, paddingRight: 0, paddingBottom: 0, width: width, height: 100)
