...
class AddListingViewController: UIViewController{
    ...
    var menuVC: DropdownMenuController!
    ...
    let internationalDeliveryView : TimeProcessingView =  {
    ...
    let labelTextView :  LabeledTextView = {
    ...
    var addItemButton : CustomButton =  {
    ...
    var descriptionTextField  : LabeledTextField =  {
       let textfield =  LabeledTextField(labelText: "Description", placeholder: "Enter an appropriate description")
        return textfield
    }()
...
//        let textField = CustomTextField(fieldType: .custom, "Title")
...
//
    ...
    let nameTextfield :BorderedTextField = {
        let textField = BorderedTextField()
        textField.placeholder = "Title"
        return textField
    }()
    var dropDownTestButton : CustomButton =  {
        let button  = CustomButton(title: "Drop Down", hasBackground: true, fontType: .medium)
    ...
    override func viewDidLoad() {
        ...
        self.returnPoliciesView.text =  self.returnPolicies
        
        imageCollectionView.dataSource = self
        imageCollectionView.delegate = self
        imageCollectionView.register(ImageListingCell.self, forCellWithReuseIdentifier: imageListingSellerIdentifier)
        menuVC = DropdownMenuController()
           menuVC.modalPresentationStyle = .popover
           menuVC.items = ["Item 1", "Item 2", "Item 3"] // The items in the dropdown
           menuVC.selectedItem = { item in
               print(item)
    ...
    private func setupUI() {
        ...
        contentView.addSubview(dropDownTestButton)
      
        contentView.addSubview(nameTextfield)
        
        contentView.addSubview(conditionView)
        contentView.addSubview(labelTextView)
        ...
        let stackview  = UIStackView(arrangedSubviews: [priceTextField, quantiyTextField])
        stackview.alignment = .fill
...
//        contentView.addSubview(originCountryTextField)
        
//        let delivery1sStackView  = UIStackView(arrangedSubviews: [originCountryLabel, originCountryTextField])
//        delivery1sStackView.alignment = .center
//        delivery1sStackView.axis =  .horizontal
//        delivery1sStackView.distribution = .fillEqually
//        delivery1sStackView.translatesAutoresizingMaskIntoConstraints =  false
//        delivery1sStackView.spacing = 20
        ...
        internationalDeliveryView.widthAnchor.constraint(equalToConstant: self.view.frame.width / 2 ).isActive = true
//        timeProcessingView.widthAnchor.constraint(equalToConstant: 20).isActive = true
//        timeProcessingView.heightAnchor.constraint(equalToConstant: 20).isActive = true
        ...
        let internationalDeliveryStackView = self.createStackView(with: [internationalDeliveryLabel, internationalDeliveryView ],  axis: .horizontal, spacing: 20)
...
//        timeProcessingView.button.addTarget(self, action:#selector(didTapNumber), for: .touchUpInside)
//        contentView.addSubview(timeProcessingView)
       
//        contentView.addSubview(delivery1sStackView)
//        deliveryStack.addArrangedSubview(originCountryLabel)
//        deliveryStack.addArrangedSubview(destinationCountryLabel)
//        deliveryStack.addArrangedSubview(processingTimeLabel)
//        deliveryStack.addArrangedSubview(standardDeliveryLabel)
//        deliveryStack.addArrangedSubview(internationalDeliveryLabel)
//        deliveryStack.addArrangedSubview(deliveryLabel)
//
//        contentView.addSubview(deliveryStack)
        
        contentView.addSubview(mainStack)
        ///Processing
//        selectableDeliveryStackView.addArrangedSubview(originCountryTextField)
//        selectableDeliveryStackView.addArrangedSubview(destinationCountryTextField)
//        contentView.addSubview(selectableDeliveryStackView)
        ...
        addItemButton.addTarget(self, action: #selector(handleAddImage), for: .touchUpInside)
        ...
        categoriesView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(handleDropDown)))
        conditionView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(handleDropDown)))
...
//        dropDownTestButton.addTarget(self, action: #selector(handleDropDown), for: .touchUpInside)
//
        
        
        nameTextfield.anchor( top: contentView.layoutMarginsGuide.topAnchor, left: contentView.leadingAnchor, right: contentView.trailingAnchor, bottom: nil, paddingTop: 10, paddingLeft: 5,paddingRight: -5, paddingBottom: 0, width: nil, height: 30)
        
        imageCollectionView.backgroundColor =  .cyan
        imageCollectionView.anchor( top: nameTextfield.bottomAnchor , left: contentView.leadingAnchor, right: contentView.trailingAnchor, bottom: nil, paddingTop: 10, paddingLeft: 0,paddingRight: 0, paddingBottom: 0, width: nil, height: self.view.frame.width)
        
        addItemButton.anchor( top: imageCollectionView.bottomAnchor, left:  nil, right:  nil, bottom: nil, paddingTop: 15, paddingLeft: 0,paddingRight: 0, paddingBottom: 0, width: self.view.frame.width / 2, height: nil)
        addItemButton.centerXAnchor.constraint(equalTo: contentView.centerXAnchor).isActive = true
        
        
        categoriesView.anchor( top: addItemButton.bottomAnchor , left: contentView.leadingAnchor, right: contentView.trailingAnchor, bottom: nil, paddingTop: 10, paddingLeft: 0,paddingRight: 0, paddingBottom: 0, width: nil, height: 40)
        ...
        labelTextView.anchor( top: conditionView.bottomAnchor , left: contentView.leadingAnchor, right: contentView.trailingAnchor, bottom: nil, paddingTop: 20, paddingLeft: 10,paddingRight:-10, paddingBottom: 0, width: nil, height: 200)
        
        stackview.anchor( top: labelTextView.bottomAnchor , left: contentView.leadingAnchor, right: contentView.trailingAnchor, bottom: nil, paddingTop: 20, paddingLeft: 10,paddingRight:-10, paddingBottom: 0, width: nil, height: 50)
        
        
        //VArition 
        variationLabel.anchor( top: stackview.bottomAnchor , left: contentView.leadingAnchor, right: nil, bottom: nil, paddingTop: 20, paddingLeft: 10,paddingRight: 0, paddingBottom: 0, width: nil, height: 30)
     
        swittchVariant.anchor( top: stackview.bottomAnchor , left: variationLabel.trailingAnchor, right: nil, bottom: nil, paddingTop: 20, paddingLeft: 5,paddingRight: 0, paddingBottom: 0, width: nil, height: 30)
        swittchVariant.centerYAnchor.constraint(equalTo: variationLabel.centerYAnchor).isActive = true
        
        addVariantButton.anchor( top: stackview.bottomAnchor , left: nil, right: contentView.trailingAnchor, bottom: nil, paddingTop: 20, paddingLeft: 0,paddingRight: -10, paddingBottom: 0, width: self.view.frame.width / 3, height: 30)
...
//        deliveryStack.anchor( top: processingLabel.bottomAnchor, left:  contentView.leadingAnchor, right:  contentView.trailingAnchor, bottom: nil, paddingTop: 10, paddingLeft: 10,paddingRight: -10, paddingBottom: 0, width: nil, height: nil)
//
//
...
//
//        timeProcessingView.anchor( top: mainStack.bottomAnchor, left:  contentView.leadingAnchor, right:  contentView.trailingAnchor, bottom: nil, paddingTop: 10, paddingLeft: 10,paddingRight: -10, paddingBottom: 0, width: nil, height: 50)
//

        
//
//        dropDownTestButton.anchor( top: returnCheckBox.bottomAnchor, left:  nil, right:  nil, bottom: nil, paddingTop: 15, paddingLeft: 0,paddingRight: 0, paddingBottom: 0, width: self.view.frame.width / 2, height: nil)
//        dropDownTestButton.centerXAnchor.constraint(equalTo: contentView.centerXAnchor).isActive = true
//
//
//
//
...
//        dropDownTestButton.centerXAnchor.constraint(equalTo: contentView.centerXAnchor).isActive = true
    ...
    @objc func handleDropDown (){
        ...
        if let popoverController = menuVC.popoverPresentationController {
            popoverController.sourceView = dropDownTestButton
            popoverController.sourceRect = CGRect(x: dropDownTestButton.bounds.midX, y: dropDownTestButton.bounds.midY, width: 0, height: 0)
...
extension AddListingViewController: UIPickerViewDelegate, UIPickerViewDataSource {
    func textFieldDidBeginEditing(_ textField: UITextField) {
     ...
     func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
         ...
         activateCountryTextField?.text = countries[row].0// Store the country code
         UIView.animate(withDuration: 0.3, animations: {
             self.pickerContainerView.frame.origin.y += self.pickerContainerView.frame.size.height
         })
     }
