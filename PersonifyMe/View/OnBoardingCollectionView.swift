...
class OnBoardingCollectionView: UICollectionView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    override init(frame: CGRect, collectionViewLayout layout: UICollectionViewLayout) {
        ...
        self.delegate = self
        self.register(OnBoardingCell.self, forCellWithReuseIdentifier: identifierBoarding)
